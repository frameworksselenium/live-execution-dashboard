...
public class IntegrationTest {
	...
	void getAllExecutionsIntegrationTest() throws JSONException {
		System.out.println("Started getAllExecutionsIntegrationTest");
		...
		System.out.println("Ended getAllExecutionsIntegrationTest");

	}

	@Test @Order(2)
	void getExecutionByIdIntegrationTest() throws JSONException {
		System.out.println("Started getExecutionByIdIntegrationTest");
		...
		System.out.println("Ended getExecutionByIdIntegrationTest");

	}

	@Test @Order(3)
	void addExecutionIntegrationTest() throws JSONException {
		System.out.println("Started addExecutionIntegrationTest");
...
//		assertEquals(HttpStatus.CREATED, response.getStatusCode());
		System.out.println(response.getBody());
		JSONAssert.assertEquals(expectedValue, response.getBody(), false);
		System.out.println("Ended addExecutionIntegrationTest");
