...
public class IntegrationTest {
	...
	void getAllExecutionsIntegrationTest() throws JSONException {
		...
		ResponseEntity<String> response = testRestTemplate.getForEntity("http://54.88.93.45:8089/getExecution", String.class);
	...
	void getExecutionByIdIntegrationTest() throws JSONException {
		...
		String expectedValue = "{\n" +
				...
				"}";
		TestRestTemplate testRestTemplate = new TestRestTemplate();
		ResponseEntity<String> response = testRestTemplate.getForEntity("http://54.88.93.45:8089/getExecution/1", String.class);
		System.out.println(response.getStatusCode());
		System.out.println(response.getBody());
	...
	void addExecutionIntegrationTest() throws JSONException {
		...
		ResponseEntity<String> response = testRestTemplate.postForEntity("http://54.88.93.45:8089/addExecution", request, String.class);
		System.out.println(response.getStatusCode());
		System.out.println(response.getBody());
