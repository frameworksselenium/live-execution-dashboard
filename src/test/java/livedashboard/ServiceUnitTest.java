...
public class ServiceUnitTest {
	...
	void getAllCountriesTest() {
		System.out.println("Started ServiceUnitTest getAllCountriesTest test completed");
		...
		assertEquals(3, size);
		System.out.println("Ended ServiceUnitTest getAllCountriesTest test completed");
	}
	
	@Test 
	@Order(2)
	void getCountryByIDTest() {
		System.out.println("Started ServiceUnitTest getCountryByIDTest test completed");
		...
		System.out.println("Ended ServiceUnitTest getCountryByIDTest test completed");
	...
	@Order(3)
	void addCountryTest() {
		System.out.println("Started ServiceUnitTest addCountryTest test completed");
		...
		System.out.println("Ended ServiceUnitTest addCountryTest test completed");
